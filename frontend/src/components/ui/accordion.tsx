...
>(({ className, children, ...props }, ref) => (
  <AccordionPrimitive.Header className="flex">
    <AccordionPrimitive.Trigger
      ref={ref}
      className={cn(
        "flex flex-1 items-center justify-between py-4 px-2 font-medium transition-all hover:bg-gray-50 dark:hover:bg-gray-700/30 rounded [&[data-state=open]>svg]:rotate-180",
        className
      )}
      {...props}
    >
